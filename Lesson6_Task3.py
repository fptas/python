...
class Position(Worker):
    ...
    def get_full_name(self):
        s = " ".join([self.position, self.name, self.surname])
        print(f"full name: {s}")
        return s
...
Position_1 = Position("Иван", "Иванов", "Столяр", 20000, 5000)
print(Position_1.name, Position_1.surname, Position_1.position, Position_1._income)

f = Position_1.get_full_name()
print(f"full name2: {f}")

f = Position_1.get_total_income()
print(f"total income2: {f}")
